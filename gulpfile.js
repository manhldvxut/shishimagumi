...
gulp.task('sass', function() {
    return gulp
        .src([srcPath + '/drone/**/*.scss', '!**/helper.scss'])
...
gulp.task(
    ...
    gulp.series(gulp.series('htmlLint', 'sass', 'jsCompile', 'browserSync'), function(done) {
        gulp.watch([srcPath + '/drone/**/*.scss'], gulp.series('sass'));
        ...
        // gulp.watch(['drone/**/*.ejs','templates/*.json'],
        //     gulp.series('ejs'));
    }),
);
